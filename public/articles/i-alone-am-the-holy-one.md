<label for="mn-intro-dirty" class="margin-toggle">&#8853;</label><input type="checkbox" id="mn-intro-dirty" class="margin-toggle"/><span class="marginnote">A dharma talk given by Daniela (Myong Soen Son Sa) at the Lexington Zen Center, November 11, 2018.</span>
<!-- more -->
...
We just finished a Kido retreat at Furnace Mountain Zen Center. 
Ki-Do means *Energy Path*. *Ki* is the same as *Chi* in Chinese, *Prana* in Sanskrit. Kido is a chanting retreat, where we practice listening deeply the entire time we are chanting and also during everything else we do while on retreat; listening with our eyes, ears, nose, tongue, body and mind.
